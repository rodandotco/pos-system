...
async function cetakLabelLangsung(barcode) {
  ...
  // Try BeePRT Style 1: SIZE/CLS/TEXT/BARCODE/PRINT
  try {
    var encoder = new TextEncoder();
    var cmd = '';
    ...
    console.log('Sending Style 1 commands...');
    ...
    alert('Label dicetak! (Style 1)');
    return;
  } catch (e1) {
    console.log('Style 1 failed:', e1.message);
  }
  
  // Try BeePRT Style 2: ^ commands
  try {
    ...
    console.log('Sending Style 2 commands...');
